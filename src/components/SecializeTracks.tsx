  ...
  return (
    <section>
      <Container>
        ...
        <div>
          {/*left*/}
          <div className='flex flex-col-reverse md:flex-row gap-x-6 gap-y-8 mt-10'>  
          <div className="shadow-xl self-start sticky top-28 
          basis-8/12 
          rounded-xl 
          border border-slate-200 py-8 px-8 ">
          ...
          {/*right*/}
          <div className='    basis-4/12 px-4 space-y-4'>     
          {data.map((item, index) => {
              return (
                <div key={index}>
                  <div
...
export default SecializeTracks
